...
def handle_mysql(data,number):
    ...
    try:
        if number > 0:
            ...
            conn.commit()
            sql_order1 = 'update user_game set game_win = game_win + 1 where name = "%s" and game="猜拳"' % name
    ...
    while True:
        ...
        for i in kl:
            if i is c1:
                ...
                if data1 == 'connected ':
                    pass
                elif data1 == '1' or data1 == '2' or data1 == '3':
                ...
                if data2 == 'connected ':
                    pass
                elif data2 == '1' or data2 == '2' or data2 == '3':
